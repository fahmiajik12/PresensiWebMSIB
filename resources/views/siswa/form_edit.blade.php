...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <h3 class="text-center mt-4">Form Edit Siswa</h3>
                <div class="card-body">
                    <form method="POST" action="{{ route('siswa.update',$row->id) }}" >
                        @csrf     
                        @method('PUT')                                                                  
                        ...
                        <fieldset class="row mb-3">
                            <legend class="col-sm-2 col-form-label">Jenis Kelamin</legend>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nama_ortu" value="{{$row->nama_ortu}}"
